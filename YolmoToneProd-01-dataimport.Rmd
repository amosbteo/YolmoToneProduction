...
# 12. Create a gender-normalized F0 column
#YolTone.df.z <- by(data = YolTone.df$F0, YolTone.df$Gender, scale)
#YolTone.df$z <- do.call(rbind, YolTone.df.z)
...
library(tidyr)
YolTone.df.wide <- spread(YolTone.df, Time, F0)
